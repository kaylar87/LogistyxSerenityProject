...
import utilities.pojo.sanders_fritom.SandersFritomPojo;
import io.restassured.http.ContentType;
...
public abstract class SFBaseNotDG_W_DATE2 {
    ...
    public static void shipmentsLabel() {
        ...
        requestJsonBodyShipments = "{\n" +
                ...
                "    \"RequestedDeliveryDateTime\": \"2022-01-28T21:16:17.565Z\",\n" +
        ...
        Response responseShipments = given().header("Shipper-Code", "VDL-NL")
        ...
        sandersFritomPojoShipments = responseShipments.as(SandersFritomPojo.class);
        ...
        JsonPath jsonPath = responseShipments.jsonPath();
        ...
        Response responseConveyances = given().header("Shipper-Code", "VDL-NL")
                .accept(ContentType.JSON)
                .contentType(ContentType.JSON)
        ...
        sandersFritomPojoConveyances = responseConveyances.as(SandersFritomPojo.class);
